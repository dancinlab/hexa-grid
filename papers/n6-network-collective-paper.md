<!-- @canonical-origin: canon@a86ca143:papers/n6-network-collective-paper.md (moved 2026-05-10) -->
<!-- gold-standard: shared/harness/sample.md -->
---
domain: network-collective
requires: []
---
# [CANONICAL v2] Ultimate network·collective (HEXA-NETWORK-COLLECTI) — n=6 Arithmetic Coordinate Mapping

> **Author**: Minwoo Park (canon)
> **Category**: network-collective — n=6 arithmetic seed paper
> **Version**: v2 (2026-04-14 canonical)
> **Upstream BT**: BT-001~005
> **Linked atlas node**: `network-collective` 0/24 EXACT [10*]

---

## 0. Abstract

This paper demonstrates that the core parameters of the network·collective domain
...
network·collective. atlas.n6 records 0/24 entries EXACT.

This paper does not claim a new network·collective; it is a seed paper that
...
network·collective is re-read within the n=6 arithmetic framework. The perfect
...
of the network·collective domain. **This paper overlays an n=6 arithmetic
coordinate system on top of existing network·collective knowledge.**

| Effect | Before | After HEXA-NETWORK-COLLECTI | Perceived change |
|--------|--------|--------------|------------------|
...
```
  Before: "Why is this network·collective value this number?" → experience/custom
  HEXA:   "This network·collective value = σ(6) or τ(6) or sopfr(6)" → number-theoretic necessity
         ↓
...
## §2 COMPARE (classical network·collective vs n=6) — performance comparison (ASCII)
...
### Performance-bar ASCII (classical network·collective vs HEXA-NETWORK-COLLECTI)
...
```
┌──────────────────────────────────────────────────────────────────────────┐
│                    HEXA-NETWORK-COLLECTI        system structure          │
├────────────┬────────────┬────────────┬────────────┬─────────────────────┤
...
4. **Domain overlap**: the σ=12 axes are shared parameters across dozens of domains beyond network·collective.
...
│  Input: network·collective raw data          │
...
HEXA-NETWORK-COLLECTI staged maturity roadmap — verification density grows per Mk:

<details open>
<summary><b>Mk.V — 2045+ full integration</b></summary>

All of network·collective is integrated with n=6 arithmetic. Cross-referenced
...
network·collective core parameters are mapped onto σ/τ/φ/sopfr/J₂.
...
#### TP-NETWORK-10: OEIS triple registration
...
Check whether the main network·collective scaling laws follow the τ(6)=4 or
...
#!/usr/bin/env python3
# -----------------------------------------------------------------------------
# §7 VERIFY -- HEXA-NETWORK-COLLECTI n=6 honesty check (stdlib only, network-collective domain)
#
...
FALSIFIERS = [
    "If network·collective key parameter n=6 alignment < 70%, retract the paper's main target",
