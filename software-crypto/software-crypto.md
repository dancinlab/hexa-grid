<!-- @canonical: canon@ded52144:domains/compute/software-crypto/software-crypto.md -->
<!-- @extracted: 2026-05-10 -->
<!-- @md5_at_extraction: 4be24c2de02ce1a3eec82397848c1b7f -->
...
# Ultimate Software Crypto (HEXA-SWCRYPTO)

## §1 WHY (how this technology changes your life)

n=6 software crypto is the product of decades of accumulated compromise. Different pitches per core, different voltages per supply, different headers per protocol.
...
```
+--------------------------------------------------------------------------+
|  [ops/s (k)] comparison: existing vs HEXA
|------------------------------------------------------------------------
|  OpenSSL AES-256        ########........................  80
|  libsodium              ##########......................  100
|  BoringSSL              #########.......................  95
|  HEXA-SWCRYPTO          ################################  288 (sigma*J2=288 scale)
|
|  [key-gen latency (us)] (lower is better)
|  RSA-4096               ################################  1000
|  Ed25519                ########........................  100
|  HEXA                   ##..............................  10
+--------------------------------------------------------------------------+
...
|-------------|---------|---------|------|-----------|------|
| cryptography | ship-7 | ship-10 | +3 | crypto primitives | [doc](../cryptography/cryptography.md) |
...
```
+--------------------------------------------------------------------------+
|                     Ultimate Software Crypto (HEXA-SWCRYPTO) system structure            |
+------------+------------+------------+------------+---------------------+
...
```
+--------------------------------------------------------------------------+
|  Ultimate Software Crypto (HEXA-SWCRYPTO) Technical Specifications      |
+--------------------------------------------------------------------------+
|  Category         security                                                |
...
Whether Ultimate Software Crypto (HEXA-SWCRYPTO) holds physically / mathematically, verified with stdlib only. The claimed design specs are cross-checked via base formulas.

### Testable Predictions (10 verifiable predictions)

#### TP-SOFTWARE-CR-1: MAC array = sigma*J2 = 288
...
#!/usr/bin/env python3
# -----------------------------------------------------------------------------
# §7 VERIFY — Ultimate Software Crypto (HEXA-SWCRYPTO) n=6 honesty verification (stdlib only, security domain)
#
...
Roadmap for actual realization of Ultimate Software Crypto (HEXA-SWCRYPTO) — each Mk step requires process / software maturity:
...
§7 10 subsection honesty verification passes. `software-crypto` document canonical v2 finalized.
